...
FIX_POSITION = {
    ...
    "יו\"ר":["י ו\"ר"],
    "יו\"רית":["י ו\"רית"],
    "דירקטור":["דירקטור /חבר",  "דירקטור/חבר", "דירקטור/חב"],
    "דירקטורית":[ "דיקטורית"],
    "דח\"צ":[],
    "דח\"צית":[],
}
...
FIX_COMPANY_NAME = {
    ...
    ')חל "צ(החברה למתנ"סים מרכזים קהילתיים בישראל בע"מ':'החברה למתנ"סים מרכזים קהילתיים בישראל בע"מ (חל"צ)',
    ')חל"צ(החברה למתנ"סים מרכזים קהילתיים בישראל בע"מ':'החברה למתנ"סים מרכזים קהילתיים בישראל בע"מ (חל"צ)',
    'רותם אינק.':'.רותם אינק',
    ...
    'ח .ל.ד חברה ממשלתית עירונית לשיקום דיור ופיתוח בע"מ':'ח.ל.ד חברה ממשלתית עירונית לשיקום דיור ופיתוח בע"מ',
    'חברה לשקום ולפתוח הרובע היהודי בע"מ':'החברה לשיקום ולפיתוח הרובע היהודי בע"מ',
    'חברת פארק  אריאל שרון בע"מ':'חברת פארק אריאל שרון בע"מ',
    ')חל"צ(דיור מוגן ורווחה לקשיש בע"מ':'דיור מוגן ורווחה לקשיש בע"מ (חל"צ)',
    '"חלמיש - חברה ממשלתית עירונית לדיור לשקום ולהתחדשות שכונות בת"א יפו בע':'חלמיש - חברה ממשלתית עירונית לדיור לשקום ולהתחדשות שכונות בת"א יפו בע"מ',
    'חלמיש - חברה ממשלתית עירונית לדיור לשקום ולהתחדשות שכונות בת"א יפו בע"':'חלמיש - חברה ממשלתית עירונית לדיור לשקום ולהתחדשות שכונות בת"א יפו בע"מ',
    ')נת"ע(חברת נתיבי תחבורה עירוניים':'חברת נתיבי תחבורה עירוניים (נת"ע)',
    ')תעש(התעשייה הצבאית לישראל בע"מ':'תעש מערכות בע"מ',
}
