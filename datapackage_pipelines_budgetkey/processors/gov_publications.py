...
def flow(parameters, *_):
    ...
    return Flow(
        ...
        add_field('documents', 'array', default=[], resources=-1),
        add_field('subject_list_keywords', 'array', default=[], resources=-1),
        add_field('ordering_units', 'array', default=[], resources=-1),
        add_field('required_documents', 'array', default=[], resources=-1),
