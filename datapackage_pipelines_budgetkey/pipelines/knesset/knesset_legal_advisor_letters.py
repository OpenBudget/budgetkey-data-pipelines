...
OUTPUT_PATH = '/var/datapackages/knesset/knesset_legal_advisor_letters'
...
def flow(*_):
    ...
    main_index = gcl.html('https://main.knesset.gov.il/about/departments/pages/leg/ldguidelines2.aspx')
    out = []
    count = 0
    existing = 0
    ...
    return DF.Flow(
        out,
        DF.update_resource(-1, name='knesset_legal_advisor_letters', path='index.csv', **{'dpp:streaming': True}),
