...
PARAMETERS = dict(
    budget_items_data=dict(
        ...
        description='''
            ...
            המידע הוא לכלל שנות התקציב מאז 1997 ועד 2026.
            בנוסף זמינה גם הצעת התקציב לשנת 2027 (השנה הנוכחית).
    ...
    income_items_data=dict(
        ...
        description='''
            ...
            בנוסף זמינה גם הערכת ההכנסות לתקציב לשנת 2026.
    ...
    contracts_data=dict(
        ...
        description='''
            ...
            המידע הוא לכלל שנות התקציב מאז 2016 ועד השנה הנוכחית (2026).
    ...
    support_programs_data=dict(
        ...
        description='''
            ...
            המידע הוא לכלל שנות התקציב מאז 2004 ועד השנה הנוכחית (2026).
