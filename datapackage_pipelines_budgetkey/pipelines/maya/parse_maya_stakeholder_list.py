...
def filter_corrupt_rows(rows):
    for row in rows:
        ...
        if 'HearatShulaim' in doc: #HearatShulaim indicates very old documents
            continue
        if 'TaarichIdkunMivne' not in doc: #Missing this field means only part of the doc was sent
            continue
        #https://mayafiles.tase.co.il/RHtm/1324001-1325000/H1324860.htm
        #https://mayafiles.tase.co.il/RHtm/1325001-1326000/H1325760.htm
