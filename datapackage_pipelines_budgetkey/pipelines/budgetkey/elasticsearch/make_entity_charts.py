    ...
    charts = [
        ...
        dict(
            ...
            subcharts=prune([
                ...
                get_municipality_graph(fn, 'צפיפות אוכלוסיה', 'נפשות לקמ״ר', [
                    ('צפיפות אוכלוסיה', 'צפיפות אוכלוסייה (נפשות לקמ"ר)'),
                ...
                get_municipality_graph(fn, 'בנייה למגורים', 'מספר דירות', [
                    ('סיום בנייה', 'גמר בנייה: מספר דירות'),
                    ('התחלת בנייה', 'התחלת בנייה: מספר דירות'),
                ]),
            ])
        ),
        dict(
        ...
        dict(
            ...
            subcharts=prune([
                ...
                get_municipality_comparison(
                    names, 'מדד חברתי-כלכלי - השוואה', 'מדד חברתי-כלכלי - דירוג (1 הנמוך ביותר)', 
                ...
                get_municipality_graph(fn, 'מקבלי קיצבאות לפי סוג', 'מקבלי קיצבאות', [
                    ...
                    ('דמי אבטלה', 'מקבלי דמי אבטלה - ממוצע חודשי'),
