...
def test():
    resource = run_parse_processor([
        ...
        {"pid": None, "url": "http://www.mr.gov.il/CentralTenders/technology/Pages/15-2016.aspx",
         "data": get_mock_exemption_data("technology-15-2016"), "tender_type": "central"},
        {"pid": None, "url": "http://www.mr.gov.il/CentralTenders/Goods/Pages/19-2017.aspx",
         "data": get_mock_exemption_data("Goods-19-2017"), "tender_type": "central"},
        {"pid": None, "url": "http://www.mr.gov.il/CentralTenders/network/Pages/michraz3.aspx",
    ...
    assert resource[6] == {'publisher_id': None, 'publication_id': 598403, 'tender_type': 'central',
                           'page_url': 'http://www.mr.gov.il/CentralTenders/Goods/Pages/19-2017.aspx',
    ...
    assert resource[7] == {'publisher_id': None, 'publication_id': 537982, 'tender_type': 'central',
                           'page_url': 'http://www.mr.gov.il/CentralTenders/network/Pages/michraz3.aspx',
