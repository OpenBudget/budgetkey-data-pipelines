        ...
        dict(
            ...
            subcharts=[
                ...
                get_municipality_graph(fn, 'מספר כיתות לפי סוג', 'כיתות', [
                    ('בתי״ס יסודיים וחינוך מיוחד', 'חינוך והשכלה - כיתות בבתי ספר יסודיים (סה"כ)'),
                    ('חטיבות ביניים', 'חינוך והשכלה - כיתות בחטיבות ביניים (סה"כ)'),
                    ('בתי״ס תיכוניים', 'חינוך והשכלה - כיתות בבתי ספר תיכוניים (סה"כ)'),
                ]),
                get_municipality_graph(fn, 'מספר תלמידים לפי סוג', 'תלמידים', [
                    ('גנים של משרד החינוך', 'חינוך והשכלה - ילדים בגנים של משרד החינוך (סה"כ)'),
                    ('בתי״ס יסודיים וחינוך מיוחד', 'חינוך והשכלה - תלמידים בבתי ספר יסודיים (סה"כ)'),
                    ('חטיבות ביניים', 'חינוך והשכלה - תלמידים בחטיבות ביניים (סה"כ)'),
                    ('בתי״ס תיכוניים', 'חינוך והשכלה - תלמידים בבתי ספר תיכוניים (סה"כ)'),
                ]),
                ...
                get_municipality_graph(fn, 'תקציב החינוך', 'אלפי ₪', [
                    ...
                    ('השתתפות ממשלתית בתקציב החינוך', 'הכנסות בתקציב הרגיל - הכנסות של הרשות ממשרד החינוך (אלפי ש"ח)'), 
                ]),
            ]
        ),
        dict(
